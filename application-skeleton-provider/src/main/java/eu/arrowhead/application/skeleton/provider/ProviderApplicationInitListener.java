...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		// per.readEnergyKWH();
		logger.info("EnergyConsumption is: " + per.readEnergyKWH());
		...
		ServiceRegistryRequestDTO serviceRequest = createServiceRegistryRequest("switch-Plug-State", "/plug/switch",
				HttpMethod.PUT);
		arrowheadService.forceRegisterServiceToServiceRegistry(serviceRequest);
		logger.info("Registered switch-Plug-State service");

		ServiceRegistryRequestDTO serviceRequest1 = createServiceRegistryRequest("plug-Energy-Consumption-KWH",
				"/plug/energy", HttpMethod.GET);
		arrowheadService.forceRegisterServiceToServiceRegistry(serviceRequest1);
		logger.info("Registered Plug-Energy-Consumption-KWH service");
	...
	public void customDestroy() {
		...
		arrowheadService.unregisterServiceFromServiceRegistry("switch-Plug-State", "/plug/switch");

		arrowheadService.unregisterServiceFromServiceRegistry("plug-Energy-Consumption-KWH", "/plug/energy");
